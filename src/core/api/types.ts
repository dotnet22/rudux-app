export interface ApiResponse<TModel> {
   ...
   * For successful responses, this contains the data
   * For error responses, this may be undefined
   */
  apiData?: TModel;
}

/**
 * Union type to handle both wrapped API responses and direct responses
 * This accommodates APIs that may return data directly or wrapped in ApiResponse
 */
export type ApiResponseOrDirect<TModel> = ApiResponse<TModel> | TModel
